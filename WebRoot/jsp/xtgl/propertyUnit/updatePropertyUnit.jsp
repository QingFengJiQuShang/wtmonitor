...
<html>
  <head>
	...
	<body>
	<form id="form" action="<%=path %>/propertyUnitAction.do?method=updateEntity" method="post"  encType="multipart/form-data">
		<div class="con">
			<p class="user">物业单位</p>
			<p class="back"  onclick="history.go(-1); "> <img src="<%=path%>/img/back.png" />返回</p>
			<div class="table">
				<p class="add">修改物业单位</p>
				<div class="table_con">
					<p class="fill">
						<label for="logn">省&nbsp;:&nbsp;</label>
						<input type="hidden"   id="provinceid"  > 
						<select  name="propertyUnit.province"  id="province"   >
					...
					<p class="fill">
						...
						<select  name="propertyUnit.city"  id="city" >
						<option value="">请选择</option>
					...
					<p class="fill">
						...
						<select  name="propertyUnit.area"  id="area" >
							<option value="">请选择</option>
							<option value="${list.area}"  selected="selected">${list.area}</option>
						</select>
					</p>
					<p class="fill">
						<label for="name">物业单位名称&nbsp;:&nbsp;</label>
						<input type="hidden" id="id"  name="propertyUnit.id"  value="${list.id}"/>
						<input type="text" id="name"  name="propertyUnit.name"  value="${list.name}" />
					</p>
			<!-- 		<p class="fill">
						<label for="logn">使用单位类型&nbsp;:&nbsp;</label>
						<select  name="propertyUnit.type"  id="type">
							<option value="">请选择</option>
					...
					<p class="fill">
						...
						<input type="text" id="liaisons"  name="propertyUnit.liaisons"  value="${list.liaisons}"/>
					</p>
					<p class="fill">
						<label for="phone">联系人电话&nbsp;:&nbsp;</label>
						<input type="text" id="phone"  name="propertyUnit.phone"  value="${list.phone}"/>
					</p>
					<p class="fill">
						<label for="area">使用单位地址&nbsp;:&nbsp;</label>
						<input type="text" id="address"  name="propertyUnit.address"  value="${list.address}" />
					</p>
					<p class="or clearfix">
