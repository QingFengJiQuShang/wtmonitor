...
<html>
  <head>
	...
	<body>
	<form id="form" action="<%=path %>/regionUnitAction.do?method=updateEntity" method="post"  encType="multipart/form-data">
		<div class="con">
			<p class="user">区域单位</p>
			<p class="back"  onclick="history.go(-1); "> <img src="<%=path%>/img/back.png" />返回</p>
			<div class="table">
				<p class="add">修改区域单位</p>
				<div class="table_con">
					<p class="fill">
					...
					<p class="fill">
						...
						<input type="hidden" id="id"  name="regionUnit.id"  value="${list.id}"/>
						<input type="text" id="name"  name="regionUnit.name"  value="${list.name}" />
					</p>
					
					<p class="fill">
						<label for="man">联系人&nbsp;:&nbsp;</label>
						<input type="text" id="liaisons"  name="regionUnit.liaisons"  value="${list.liaisons}"/>
					</p>
					<p class="fill">
						<label for="phone">联系人电话&nbsp;:&nbsp;</label>
						<input type="text" id="phone"  name="regionUnit.phone"  value="${list.phone}"/>
					</p>
					<p class="fill">
						<label for="area">区域单位地址&nbsp;:&nbsp;</label>
						<input type="text" id="address"  name="regionUnit.address"  value="${list.address}" />
					</p>
					<p class="or clearfix">
