			...
			<div class="warp">
				...
				<div class="table">
					<div class="or clearfix">
						<%if(Authority.haveRigth(user.getId(),"dwgl_jydw_add")) {%>
						<p class="fl add"    onclick="add();"><img src="<%=path%>/img/add.png" />新增</p>
						<%} %>
						<%if(Authority.haveRigth(user.getId(),"dwgl_jydw_del")) {%>
						<p class="fl del">批量删除</p>
						<%} %>
            <%if(Authority.haveRigth(user.getId(),"dwgl_jydw_exp")) {%>
						<p class="fl add" onclick="exp();">&nbsp;&nbsp;下载&nbsp;&nbsp;</p>
            <%} %>
            <%if(Authority.haveRigth(user.getId(),"dwgl_jydw_upload")) {%>
							...
							<c:forEach items="${list}" var="list" varStatus="s">
								<tr>
									...
									<td>
										...
										<%if(Authority.haveRigth(user.getId(),"dwgl_jydw_update")) {%>
