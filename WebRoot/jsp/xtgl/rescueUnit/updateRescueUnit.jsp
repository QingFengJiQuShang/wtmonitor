...
<html>
  <head>
	...
	<body>
	<form id="form" action="<%=path %>/rescueUnitAction.do?method=updateEntity" method="post"  encType="multipart/form-data">
		<div class="con">
			<p class="user">救援单位</p>
			<p class="back"  onclick="history.go(-1); "> <img src="<%=path%>/img/back.png" />返回</p>
			<div class="table">
				<p class="add">修改救援单位</p>
				<div class="table_con">
					<p class="fill">
						<label for="logn">省&nbsp;:&nbsp;</label>
						<input type="hidden"   id="provinceid"  > 
						<select  name="rescueUnit.province"  id="province"   >
					...
					<p class="fill">
						...
						<select  name="rescueUnit.city"  id="city">
						<option value="">请选择</option>
					...
					<p class="fill">
						...
						<select  name="rescueUnit.area"  id="area" >
							<option value="">请选择</option>
					...
					<p class="fill">
						...
						<input type="hidden" id="id"  name="rescueUnit.id"  value="${list.id }"/>
						<input type="text" id="name"  name="rescueUnit.name"  value="${list.name }"/>
					</p>
					<p class="fill">
					...
					<p class="fill">
						...
						<input type="text" id="liaisons"  name="rescueUnit.liaisons"   value="${list.liaisons }"/>
					</p>
					<p class="fill">
						<label for="phone">联系人电话&nbsp;:&nbsp;</label>
						<input type="text" id="phone"  name="rescueUnit.phone"   value="${list.phone}"/>
					</p>
					<p class="fill">
						<label for="area">救援单位地址&nbsp;:&nbsp;</label>
						<input type="text" id="address"  name="rescueUnit.address"   value="${list.address }"/>
					</p>
					<p class="or clearfix">
