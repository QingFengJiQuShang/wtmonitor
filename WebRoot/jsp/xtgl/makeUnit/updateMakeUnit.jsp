...
<html>
  <head>
	...
	<body>
	<form id="form" action="<%=path %>/makeUnitAction.do?method=updateEntity" method="post"  encType="multipart/form-data">
		<div class="con">
			<p class="user">制造单位</p>
			<p class="back"  onclick="history.go(-1); "> <img src="<%=path%>/img/back.png" />返回</p>
			<div class="table">
				<p class="add">修改制造单位</p>
				<div class="table_con">
					<p class="fill">
					...
					<p class="fill">
						...
						<select  name="makeUnit.area"  id="area" >
							<option value="">请选择</option>
					...
					<p class="fill">
						...
						<input type="hidden" id="id"  name="makeUnit.id"  value="${list.id}"/>
						<input type="text" id="name"  name="makeUnit.name"  value="${list.name}" />
					</p>
		<!-- 			<p class="fill">
					...
					<p class="fill">
						...
						<input type="text" id="liaisons"  name="makeUnit.liaisons"  value="${list.liaisons}"/>
					</p>
					<p class="fill">
						<label for="phone">联系人电话&nbsp;:&nbsp;</label>
						<input type="text" id="phone"  name="makeUnit.phone"  value="${list.phone}"/>
					</p>
					<p class="fill">
						<label for="area">制造单位地址&nbsp;:&nbsp;</label>
						<input type="text" id="address"  name="makeUnit.address"  value="${list.address}" />
					</p>
					<p class="or clearfix">
	...
	<script src="<%=path%>/js/jquery.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="<%=path%>/js/xtgl/makeUnit.js" type="text/javascript" charset="utf-8"></script>
