			...
			<div class="warp">
				...
				<div class="table">
					<div class="or clearfix">
						...
						<p class="fl add" onclick="exp1('2');" style="width: 100px;">下载</p>
            			<%} %>
					</div>
				<div class="table_con">
						<table border="" cellspacing="" cellpadding="">
							...
							<c:forEach items="${list}" var="list" varStatus="s">
								<tr>
									...
									<td>${list.numbers}</td>
									<td>${list.state}</td>
									<td><a href="<%=path %>/safeAction.do?method=query&elevatorId=${list.id}"   style="color: blue; ">${list.num}</a></td>
