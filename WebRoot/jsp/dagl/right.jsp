...
<meta charset="utf-8" />
	...
	<iframe width="100%" height="570" id="main" name="main" frameborder=0 scrolling=no src="<%=path%>/regionAction.do?method=query"  style="margin-top: -4px; margin-bottom: -20px;"></iframe>
