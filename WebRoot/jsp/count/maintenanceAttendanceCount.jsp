...
<script type="text/javascript" src="<%=path %>/js/Share.js"></script>
	...
	<body>
		<div class="con" id="user">
            ...
            <%if(Authority.haveRigth(user.getId(),"tjfx_wbcqtj_exp")) {%>
	...
	function gotoUrl (){
	 ...
	 //模糊查询
		function query(){
    		  window.location.href="<%=path%>/countAction.do?method=maintenanceAttendanceCount"+gotoUrl();
		  }
	  //下载
		  function exp(){
    		  window.location.href="<%=path%>/countAction.do?method=exportMaintenanceAttendanceCount"+gotoUrl ();
         }
	</script>
