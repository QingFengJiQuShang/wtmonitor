			...
			<div class="warp">
				...
				<div class="table">
					...
					<div class="or clearfix">
						<%if(Authority.haveRigth(user.getId(),"dtjk_bmd_add")) {%>
						<p class="fl add"    onclick="add('${elevatorId}');"><img src="<%=path%>/img/add.png" />新增</p>
						<%} %>
						<%if(Authority.haveRigth(user.getId(),"dtjk_bmd_del")) {%>
						<p class="fl del">批量删除</p>
						<%} %>
            <%if(Authority.haveRigth(user.getId(),"dtjk_bmd_exp")) {%>
							...
							<c:forEach items="${list}" var="list" varStatus="s">
								<tr>
									...
									<td>
										...
										<%if(Authority.haveRigth(user.getId(),"dtjk_bmd_update")) {%>
