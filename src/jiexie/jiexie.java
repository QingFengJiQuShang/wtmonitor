...
public class jiexie {
	...
	public Entity query(String str,OutputStream os ){
		...
		System.out.println("电梯id："+convertHexToString(elevatorId));
		
		String gatewayId=str.substring(46,68); 
		System.out.println("网关id："+convertHexToString(gatewayId));
		
		String type=str.substring(68,70); 
		System.out.println("数据类型："+judgeType(type));
		
		
		if(type.equalsIgnoreCase("20")||type.equalsIgnoreCase("23")){     //上报运行数据
			//循环  解析命令
