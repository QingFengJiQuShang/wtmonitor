...
public class XtglMakeUnitDaoImpl  extends BaseDaoImpl< XtglMakeUnit, String> implements  XtglMakeUnitDao{

	@Override
	public Class<? extends Object> getEntityClass() {
		// TODO Auto-generated method stub
		return  XtglMakeUnit.class;
	}
	...
	public void export(String filePath, XtglMakeUnit unit) {
		try {
			...
			HSSFRow row = null;
			HSSFCell cell = null;
			List<XtglMakeUnit> list=new ArrayList<XtglMakeUnit>();
			...
			while(rs.next()){
				XtglMakeUnit elevators=new XtglMakeUnit();
			...
			if (1 == 1) {
				top_arraydis = ExcelColumns.XtglMakeUnit;
				...
				for (int i = 0; i < list.size(); i++) {
					    ...
					    XtglMakeUnit	e = (XtglMakeUnit) list.get(i);
