...
public class XtglRegionUnitDaoImpl  extends BaseDaoImpl< XtglRegionUnit, String> implements  XtglRegionUnitDao{

	@Override
	public Class<? extends Object> getEntityClass() {
		// TODO Auto-generated method stub
		return  XtglRegionUnit.class;
	}
	...
	public void export(String filePath, XtglRegionUnit unit) {
		try {
			...
			HSSFRow row = null;
			HSSFCell cell = null;
			List<XtglRegionUnit> list=new ArrayList<XtglRegionUnit>();
			...
			//查询服务订单
			String sql="select dr.*  from Xtgl_Region_Unit dr where  1=1 " ;
			...
			while(rs.next()){
				XtglRegionUnit elevators=new XtglRegionUnit();
			...
			if (1 == 1) {
				top_arraydis = ExcelColumns.XtglRegionUnit;
				...
				for (int i = 0; i < list.size(); i++) {
					    ...
					    XtglRegionUnit	e = (XtglRegionUnit) list.get(i);
