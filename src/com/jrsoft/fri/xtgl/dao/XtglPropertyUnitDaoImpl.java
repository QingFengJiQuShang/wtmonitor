...
public class XtglPropertyUnitDaoImpl  extends BaseDaoImpl< XtglPropertyUnit, String> implements  XtglPropertyUnitDao{

	@Override
	public Class<? extends Object> getEntityClass() {
		// TODO Auto-generated method stub
		return  XtglPropertyUnit.class;
	}
	...
	public void export(String filePath, XtglPropertyUnit unit) {
		try {
			...
			HSSFRow row = null;
			HSSFCell cell = null;
			List<XtglPropertyUnit> list=new ArrayList<XtglPropertyUnit>();
			...
			while(rs.next()){
				XtglPropertyUnit elevators=new XtglPropertyUnit();
			...
			if (1 == 1) {
				top_arraydis = ExcelColumns.XtglPropertyUnit;
				...
				for (int i = 0; i < list.size(); i++) {
					    ...
					    XtglPropertyUnit	e = (XtglPropertyUnit) list.get(i);
