...
public class StringUtils {
    ...
    /**
     * 字符串(2012-12-23)转日期java.util.Date
     * @return
     */
    ...
    */
     ...
     */
     ...
     /**
      * get the value of the n th of the long String which split by character[',',';']
      * @param str:long String
      * @param n:then n th item
      * @return this value
      */
    ...
    public static void main(String[] args)
    {
      ...
      String xx=su.getFile("/Document/File/ba.doc");
