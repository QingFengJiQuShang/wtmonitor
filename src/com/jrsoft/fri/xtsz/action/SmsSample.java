...
public class SmsSample {
	 ...
	 */
	 public static String sendMessage(String phone,String Content) {
	        ...
	        String testUsername = "zhonghuiwulianwang"; //在短信宝注册的用户名
	        String testPassword = "zh168168"; //在短信宝注册的密码
	 ...
	 public static void main(String[] args) {
	        ...
	        String testUsername = "zhonghuiwulianwang"; //在短信宝注册的用户名
	        String testPassword = "zh168168"; //在短信宝注册的密码
	        String testPhone = "15301320368";
	        String testContent = "【中慧】电梯报警测试！。"; // 注意测试时，也请带上公司简称或网站签名，发送正规内容短信。千万不要发送无意义的内容：例如 测一下、您好。否则可能会收不到
